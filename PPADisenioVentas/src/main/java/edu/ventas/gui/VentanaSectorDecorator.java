...
public class VentanaSectorDecorator implements VentanaDecoratorInterface,
	...
	private void dibujarFila(Fila fila, JFrame frame) {
		...
		for (Butaca butaca : butacas) {
			if (butaca != null) {
				if(compradas.contains(butaca.getIdButaca()))
				{
